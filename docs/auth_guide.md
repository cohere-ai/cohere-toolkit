...
- OpenIDConnect: To enable this strategy, you will need to configure your SSO app and retrieve `OIDC_CLIENT_ID`, `OIDC_CLIENT_SECRET`, and `OIDC_WELL_KNOWN_ENDPOINT` values.
...
`<FRONTEND_HOST>/auth/<STRATEGY_NAME>`, for example, `http://localhost:4000/auth/google` if you're running the GoogleOAuth class locally.
