...
# def test_create_existing_agent(session_client: TestClient, session: Session, user) -> None:
...
# def test_get_nonexistent_agent(session_client: TestClient, session: Session, user) -> None:
...
# def test_partial_update_agent(session_client: TestClient, session: Session, user) -> None:
#     agent = get_factory("Agent", session).create(
#         name="test agent",
#         version=1,
#         description="test description",
...
# def test_update_nonexistent_agent(session_client: TestClient, session: Session, user) -> None:
#     request_json = {
#         "name": "updated name",
#     }
#     response = session_client.put(
...
# def test_update_agent_wrong_user(session_client: TestClient, session: Session, user) -> None:
...
# def test_get_agent_tool_metadata(session_client: TestClient, session: Session, user) -> None:
#     agent = get_factory("Agent", session).create(user_id="123")
