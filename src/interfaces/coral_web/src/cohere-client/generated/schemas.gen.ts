...
export const $Agent = {
    ...
    type: 'object',
    required: ['user_id', 'id', 'created_at', 'updated_at', 'version', 'name', 'description', 'preamble', 'temperature', 'tools', 'tools_metadata', 'model', 'deployment'],
    title: 'Agent'
} as const;
...
export const $AgentPublic = {
    ...
    type: 'object',
    required: ['id', 'created_at', 'updated_at', 'version', 'name', 'description', 'preamble', 'temperature', 'tools', 'model', 'deployment'],
    title: 'AgentPublic'
} as const;
...
export const $Conversation = {
    ...
    type: 'object',
    required: ['user_id', 'id', 'created_at', 'updated_at', 'title', 'messages', 'files', 'description', 'agent_id', 'total_file_size'],
    title: 'Conversation'
} as const;
...
export const $ConversationWithoutMessages = {
    ...
    type: 'object',
    required: ['user_id', 'id', 'created_at', 'updated_at', 'title', 'files', 'description', 'agent_id', 'total_file_size'],
...
export const $File = {
    ...
    type: 'object',
    required: ['id', 'created_at', 'updated_at', 'user_id', 'conversation_id', 'file_name', 'file_path'],
    title: 'File'
} as const;
...
export const $Message = {
    ...
    type: 'object',
    required: ['text', 'id', 'created_at', 'updated_at', 'generation_id', 'position', 'is_active', 'documents', 'citations', 'files', 'tool_calls', 'tool_plan', 'agent'],
    title: 'Message'
} as const;
...
export const $NonStreamedChatResponse = {
    ...
    type: 'object',
    required: ['response_id', 'generation_id', 'chat_history', 'finish_reason', 'text', 'conversation_id'],
...
export const $Snapshot = {
    ...
    type: 'object',
    required: ['conversation_id', 'id', 'last_message_id', 'user_id', 'organization_id', 'version', 'created_at', 'updated_at', 'snapshot'],
    title: 'Snapshot'
} as const;
...
export const $SnapshotWithLinks = {
    ...
    type: 'object',
    required: ['conversation_id', 'id', 'last_message_id', 'user_id', 'organization_id', 'version', 'created_at', 'updated_at', 'snapshot', 'links'],
...
export const $StreamEvent = {
    type: 'string',
    enum: ['stream-start', 'search-queries-generation', 'search-results', 'tool-input', 'tool-result', 'text-generation', 'citation-generation', 'stream-end', 'non-streamed-chat-response', 'tool-calls-generation', 'tool-calls-chunk'],
    title: 'StreamEvent',
