...
export const $AgentPublic = {
    ...
    type: 'object',
    required: ['user_id', 'id', 'created_at', 'updated_at', 'version', 'name', 'description', 'preamble', 'temperature', 'tools', 'deployments', 'deployment', 'model', 'is_private'],
    title: 'AgentPublic'
} as const;
...
export const $ConversationPublic = {
    ...
    type: 'object',
    required: ['id', 'created_at', 'updated_at', 'title', 'messages', 'files', 'description', 'agent_id', 'is_pinned', 'total_file_size'],
...
export const $ConversationWithoutMessages = {
    ...
    type: 'object',
    required: ['id', 'created_at', 'updated_at', 'title', 'files', 'description', 'agent_id', 'is_pinned', 'total_file_size'],
...
export const $SnapshotPublic = {
    ...
    type: 'object',
    required: ['conversation_id', 'id', 'last_message_id', 'version', 'created_at', 'updated_at', 'snapshot'],
...
export const $SnapshotWithLinks = {
    ...
    type: 'object',
    required: ['conversation_id', 'id', 'last_message_id', 'version', 'created_at', 'updated_at', 'snapshot', 'links'],
