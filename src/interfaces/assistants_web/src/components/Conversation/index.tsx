...
const Conversation: React.FC<Props> = ({
  ...
  return (
    <div className="flex h-full w-full">
      <div className="flex h-full w-full min-w-0 flex-col rounded-l-lg rounded-r-lg border border-marble-950 bg-marble-1000 md:rounded-r-none dark:border-volcanic-200 dark:bg-volcanic-100">
