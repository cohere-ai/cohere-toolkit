  ...
  return (
    <Text
      ...
      className={cn(
        ...
        'prose-img:my-2',
        'prose-headings:my-0',
        'prose-blockquote:prose-quoteless',
        ...
        'dark:text-marble-950 dark:prose-strong:text-marble-1000 dark:prose-code:text-marble-950 dark:prose-pre:border-none dark:prose-pre:bg-volcanic-200 dark:prose-img:invert',
        className
      )}
      {...rest}
    >
