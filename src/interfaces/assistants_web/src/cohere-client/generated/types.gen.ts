...
export type GetCarbonTokensV1FetchCarbonTokensGetData = {
  customerId: string;
};

export type GetCarbonTokensV1FetchCarbonTokensGetResponse = unknown;
...
export type $OpenApiTs = {
  '/v1/fetch_carbon_tokens': {
    get: {
      req: GetCarbonTokensV1FetchCarbonTokensGetData;
      res: {
        /**
         * Successful Response
         */
