...
export type ConversationFileFull = {
  id: string;
  user_id: string;
  created_at: string;
  updated_at: string;
...
export type GetFileV1ConversationsConversationIdFilesFileIdGetResponse = ConversationFileFull;
...
export type GetAgentFileV1AgentsAgentIdFilesFileIdGetResponse = AgentFileFull;
